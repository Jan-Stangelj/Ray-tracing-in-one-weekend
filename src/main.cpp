...
int main() {
    ...
    renderer.scene.materials.push_back(rt::createLambertian(glm::vec3(0.6f, 0.2f, 0.2f)));
    ...
    renderer.scene.spheres.emplace_back(glm::vec3(0.0f, 0.0f, 0.0f), 0.5f, 4);
    renderer.scene.spheres.emplace_back(glm::vec3(-1.0f, 0.0f, 0.0f), 0.5f, 2);
    renderer.scene.spheres.emplace_back(glm::vec3(0.0f, 1.0f, 0.0f), 0.5f, 1);
